...
echo "	C_DOUT_L (31 downto 0) <= output (31 downto 0);" >> 440.vhd
echo "	F_DOUT_L (31 downto 0) <=  output (31 downto 0);" >> 440.vhd
...
echo "	results (3 downto 0) <= aVar7S0 (14 downto 11);" >> 440.vhd
echo 'cut <="1111";'>> 440.vhd
echo "lookuptable_LV6 : process(c1)" >> 440.vhd
echo "begin" >> 440.vhd
echo " if c1'event and c1='1' then" >> 440.vhd
echo "	if(aVar7S0(15)='0')then " >> 440.vhd
echo '		output(31 downto 0) <= "11111111111111111111111111111111";' >> 440.vhd
echo "	else if( results<cut )then " >> 440.vhd
echo '		output(31 downto 0) <= "11111111111111111111111111111111"; ' >> 440.vhd
echo "		else " >> 440.vhd
echo '		output(31 downto 0) <= "00000000000000000000000000000000"; ' >> 440.vhd
echo "		end if; " >> 440.vhd
echo " end if; " >> 440.vhd
echo "end if; " >> 440.vhd
echo "end process;" >> 440.vhd
