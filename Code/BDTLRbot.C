...
TFile *data= new TFile("run5rootm1/n3mc_m2_top.root","READ");
TFile *datab= new TFile("m2rootfiles/BDT_n3_mc_highxT_all_run5.root","READ");
//TFile *data= new TFile("n3mc_m2_bot.root","READ");
//TFile *data= new TFile("BDT_n3_mc_nim3mc_high_xT_binary_m1off_run5.root","READ");
...
/*	sprintf(lname,"h4Y1Lr%i",i);
	...
	factory->BookMethod(TMVA::Types::kBDT,
		                 "BDT",
		    "NTrees=128:MaxDepth=6:SeparationType=CrossEntropy"
	                   ); //this parameter can be changed GiniIndexWithLaplace CrossEntropy
//	factory->BookMethod(TMVA::Types::kRuleFit,
//		                 "RuleFit",
//		                 "nTrees=100:RFTMVA:MinImp=.001:RuleMinDist=0.0001"
//	                   ); 
