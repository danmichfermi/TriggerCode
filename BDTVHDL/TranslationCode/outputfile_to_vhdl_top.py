...
#	document = open('weight_file_top.txt')
	document = open('LRbot_m2_true_sigma.xml')
...
document = open(cfile)
document2 = open('vhd_text_top.txt','w')
document3 = open('vhd_text_top_tables.txt','w')
...
outFile = open('aVarOutputtop.txt', 'w') #this will be the file to write to
