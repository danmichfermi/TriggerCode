...
TTree *road77 = (TTree*)(roadfile->Get("77"));
TTree *road57 = (TTree*)(roadfile->Get("57"));
...
TH1F *h5= new TH1F("h5","Mass 57", 50,2,10);
TH1F *h6= new TH1F("h6","Mass 77", 50,2,10);
...
h5->Draw("");
c1->SaveAs("Mass_57.png");
h6->Draw();
c1->SaveAs("Mass_77.png");
...
float zeff=ztotal;
cout<<"77  "<<(zeff/(signal->GetEntries()))<<endl;
}
