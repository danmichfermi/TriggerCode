...
TFile *data= new TFile("datasep.root","READ");
...
for(int i=1; i<24 ; i++){
	...
	factory->AddVariable(arg1,'/I');
	factory->AddVariable(arg2,'/I');
}
for(int i=1; i<17 ; i++){
	char* tname[10];
	char* bname[10];
...
//	factory->AddVariable("q2",'I');
	...
	factory->BookMethod(TMVA::Types::kBDT,"BDT","NTrees=400:MaxDepth=5"); //this parameter can be changed
